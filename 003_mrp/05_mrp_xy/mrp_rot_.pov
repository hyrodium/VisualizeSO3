...
#fopen MyFile_x "../02_mrp_x/rot_x.txt" read
#declare M=60;
#declare e1_x=array[M];
#declare e2_x=array[M];
#declare e3_x=array[M];
#declare p_x=array[M];
...
#fopen MyFile_y "../03_mrp_y/rot_y.txt" read
#declare M=60;
#declare e1_y=array[M];
#declare e2_y=array[M];
#declare e3_y=array[M];
#declare p_y=array[M];
...
#declare M=60;
#declare e1_xy=array[M];
#declare e2_xy=array[M];
#declare e3_xy=array[M];
#declare p_xy=array[M];
...
#fopen MyFile_yx "rot_yx.txt" read
#declare M=60;
#declare e1_yx=array[M];
#declare e2_yx=array[M];
#declare e3_yx=array[M];
#declare p_yx=array[M];
...
// MRP Point
sphere{p_x[N],0.05 pigment{rgb<1,0,0>} translate -X*D}
sphere{p_y[N],0.05 pigment{rgb<0,1,0>} translate -X*D}
sphere{p_xy[N],0.05 pigment{rgb<1,0,1>} translate -X*D}
sphere{p_yx[N],0.05 pigment{rgb<0,1,1>} translate -X*D}
